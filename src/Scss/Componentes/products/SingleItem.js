...
const SingleItem = ({data}) => {
    ...
    return (
        <>
            <div className="aem-Grid aem-Grid--12 container main">
                <div className='aem-GridColumn aem-GridColumn--default--7'>
                    <div className="aem-Grid aem-Grid--12" >
                        <div className='aem-GridColumn aem-GridColumn--default--2 single'>
                        ...
                        <div className='aem-GridColumn aem-GridColumn--default--10 full-image'>
                            <img src={data.image} alt="Product" />
                        </div>
                    </div>
                </div>

                <div className='aem-GridColumn aem-GridColumn--default--5 detail-info'>
            ...
            <div className='aem-Grid aem-Grid--12 description-product container main'>
                <div className='aem-Grid aem-Grid--12'>
